...
class QuestionResults extends Component {
    render() {
        ...
        const { question, authedUser, avatar } = this.props
                        ...
                        <div className='col sm-8'>
                            ...
                            <Card className='mb-3' color='light'>
                                ...
                                <CardBody>
                                    ...
                                    <Progress className='mb-3' value={optionOnePerc} color='info'>{optionOnePerc}%</Progress>
                                    <CardText>{optionOneVotes} out of {totalVotes} votes</CardText>
                                </CardBody>
                            </Card>
                            <Card color='light'>
                                ...
                                <CardBody>
                                    ...
                                    <Progress className='mb-3' value={optionTwoPerc} color='info'>{optionTwoPerc}%</Progress>
                                    <CardText>{optionTwoVotes} out of {totalVotes} votes</CardText>
                                </CardBody>
                            </Card>
                        </div>
                    </div>
